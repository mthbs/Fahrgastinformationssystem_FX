...
public class JSONConnection {
    ...
    public void createList() throws IOException {
        allConnections = objectMapper.readValue(new File("C:\\Users\\derma\\OneDrive\\Documents\\Java " +
                "Projects\\Fahrgastinformationssystem_FX\\resources\\JSON\\routes.json"), Unterwegshalte[].class);
    }
